...
saveRDS(obj,'/data/jiangjunyao/polyATAC/nmp_final/nmp_sp_pm_only_rna.rds')
...
final_fea = final_fea[final_fea %in% rownames(pm_smooth)]
final_fea = final_fea[final_fea %in% rownames(sp_smooth)]
...
saveRDS(dual_lineage,'/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/dual_lineage_mt.rds')
write.csv(pm_smooth,'/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/pm_smooth.csv')
write.csv(sp_smooth,'/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/sp_smooth.csv')
write.csv(sp_de,'/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/sp_deg.csv')
write.csv(pm_de,'/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/pm_deg.csv')
...
### do heatmap
dual_lineage = readRDS('/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/dual_lineage_mt.rds')
...
pdf('/data/jiangjunyao/polyATAC/polyatac_figure/single cell fig/NMP_fate_analysis/gene_module_heatmap2.pdf',width = 10,height = 8)
colnames(dual_lineage) = 1:200
...
pdf('/data/jiangjunyao/polyATAC/polyatac_figure/single cell fig/NMP_fate_analysis/inter module regulation_single gene.pdf',width = 10,height = 8)
...
pdf('/data/jiangjunyao/polyATAC/polyatac_figure/single cell fig/NMP_fate_analysis/inter module regulation.pdf',width = 10,height = 8)
...
selected_func = rbind(
                      em_go@result[c(4,24,30,67,74,110),],
                      en_go@result[c(1,3,13,22),])
...
write.csv(selected_func,'/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/selected_module_GO_terms_0328.csv')
ggplot(selected_func,aes(y=reorder(Description,rank),x=logq,fill=group))+
  ...
  xlab('-log10 qvalue')+
  ylab('GO terms')+theme(text = element_text(size=16))
ggsave('/data/jiangjunyao/polyATAC/polyatac_figure/single cell fig/NMP_fate_analysis/module_GO.pdf',
       width = 10,height = 8)
write.csv(bi_go@result,
          '/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/Bipotent_go.csv')
write.csv(lm_go@result,
          '/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/lm_go.csv')
write.csv(ln_go@result,
          '/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/ln_go.csv')
write.csv(em_go@result,
          '/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/em_go.csv')
write.csv(en_go@result,
          '/data/jiangjunyao/polyATAC/nmp_final/nmp_pseudotime_module/only_rna/en_go.csv')
